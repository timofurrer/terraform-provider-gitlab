...
- `protected_branch` (Set of Object) The list of protected branches for the project. (see [below for nested schema](#nestedatt--protected_branch))
...
<a id="nestedatt--protected_branch"></a>
### Nested Schema for `protected_branch`

Optional:

- `allow_force_push` (Boolean)
- `allowed_to_merge` (Set of Object) (see [below for nested schema](#nestedobjatt--protected_branch--allowed_to_merge))
- `allowed_to_push` (Set of Object) (see [below for nested schema](#nestedobjatt--protected_branch--allowed_to_push))
- `allowed_to_unprotect` (Set of Object) (see [below for nested schema](#nestedobjatt--protected_branch--allowed_to_unprotect))
- `branch` (String)
...
<a id="nestedobjatt--protected_branch--allowed_to_merge"></a>
### Nested Schema for `protected_branch.allowed_to_merge`
...
<a id="nestedobjatt--protected_branch--allowed_to_push"></a>
### Nested Schema for `protected_branch.allowed_to_push`
...
<a id="nestedobjatt--protected_branch--allowed_to_unprotect"></a>
### Nested Schema for `protected_branch.allowed_to_unprotect`
